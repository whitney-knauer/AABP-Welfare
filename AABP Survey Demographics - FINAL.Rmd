...
#NEED TO DO LIKELIHOOD RATIO TEST? COMPARE FULL MODEL TO REDUCED MODEL (ANOVA(REDUCED, FULL))
  ...
  geom_bar(stat = "identity", position = "stack", color = "black") +
      geom_text(
        aes(label = ifelse(Percentage > 1, Percentage, "")),
            ...
            family = "Times New Roman") + 
    scale_fill_manual(values = c(
              "Strongly_Agree" = "#8ec1da",
              "Somewhat_Agree" =  "#cde1ec", 
              "Neutral" = "#ededed", 
              "Somewhat_Disagree" = "#f6d6c2",
              "Strongly_Disagree" = "#d47264"),
